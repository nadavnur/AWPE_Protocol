...
## This code takes as input an simulations file and a yaml on how to process it, and produces 
#
...
# For each year of the simulation we determined which sites were surveyed and how many times for N or F. 
